...
- [ ] ② 进化/战斗动画增强 — sprite sheet 动画替换当前 CSS 动画 🔄 动画引擎完整 (idle呼吸/平滑移动/行走弹跳±3°/拖尾残影/邻近连线/精灵色光环/随机相位), 精灵数据 29 种已齐全, **待用户决策**: sprite 素材生成方案 (AI 管线 vs 手工绘制)
