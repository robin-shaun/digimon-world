...
- [ ] ① 数码兽 TTS 配音 — 每只数码兽有独特声线 (Edge TTS / Fish Audio) 🔄 后端+前端完成, 待集成 Cloudflare Worker 流式音频
...
- [x] ⑤ 世界存档系统 — 定时快照 + 版本迁移 + 回滚 ✅ (`44f641d`)
- [x] ⑥ 管理后台 — 世界管理/Agent 控制/日志查询 Web UI ✅ (POC: admin.html, 本 commit)
